    ...
    try:
        ...
        #and frame['RISK'].iloc[-1]<=riskvalue:
            ...
            #or framew['Close'].iloc[-1]>framew['sup2'].iloc[-1] or framew['Close'].iloc[-1]>framew['sup4'].iloc[-1])):
                ...
                if option2 == 'breakout':
                   if (frame['EMA20_cross'].iloc[-h1]=='Buy' or frame['EMA50_cross'].iloc[-h1]=='Buy' or frame['Decision Super2'].iloc[-h1]=='Buy'\
                   or framew['Decision Super'].iloc[-h1]=='Buy')\
                   and (frame['Dec_EMA50'].iloc[-h1]=='Buy' and frame['Decision Super3'].iloc[-h1]=='Buy')\
                   and (frame['Close'].iloc[-h1]>frame['sup6'].iloc[-h1] and framew['Close'].iloc[-h1]>framew['sup2'].iloc[-h1]):
                ...
                if option2 == 'pullback':  
                   ...
                   or frame['Decision Super2'].iloc[-h1]=='Buy' or frame['EMA50_cross'].iloc[-h1]=='Buy'\
                   or frame['EMA50_cross'].iloc[-h1-1]=='Buy2' or frame['EMA200_cross'].iloc[-h1]=='Buy2'\
                   or framew['Decision Super2'].iloc[-h1]=='Buy2' or framew['Decision Super3'].iloc[-h1]=='Buy2'\
                   or framew['EMA20_cross'].iloc[-h1-1]=='Buy2' or framew['EMA50_cross'].iloc[-h1-1]=='Buy2')\
                   and (framew['Dec_EMA50'].iloc[-h1]=='Buy' and framew['Close'].iloc[-1]>framew['sup6'].iloc[-1])\
                   and frame['Dec_EMA20'].iloc[-h1]=='Buy'\
                ...
                if option2 == 'consolidating':             
                   ...
                   and (frame['Dec_EMA20'].iloc[-h1]=='Buy' and framew['Dec_EMA50'].iloc[-h1]=='Buy')\
                   and frame['Trend MACD'].iloc[-1]=='Buy':
                            sira +=1
                            expander('consolidating') 
                   if option2 == 'week':
                    if (framew['Decision Super2'].iloc[-1]=='Buy' or framew['Decision Super3'].iloc[-1]=='Buy')\
            ...
            #(framew['Trend MACD'].iloc[-1]=='Sell' or framew['Dec_EMA50'].iloc[-1]=='Sell'):
                ...
                if option2=='pullback':
                   ...
                   and (framew['Dec_EMA50'].iloc[-h1]=='Sell' and framew['Close'].iloc[-1]<framew['sup6'].iloc[-1])\
