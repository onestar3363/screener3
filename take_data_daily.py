    ...
    try:
        ...
        #and frame['RISK'].iloc[-1]<=riskvalue:
            ...
            #or framew['Close'].iloc[-1]>framew['sup2'].iloc[-1] or framew['Close'].iloc[-1]>framew['sup4'].iloc[-1])):
                ...
                if option2 == 'breakout':
                   if (frame['EMA50_cross'].iloc[-h1]=='Buy' or frame['EMA50_cross'].iloc[-h1]=='Buy' or frame['Decision Super2'].iloc[-h1]=='Buy')\
                   and (frame['Dec_EMA50'].iloc[-h1]=='Buy' and frame['Close'].iloc[-h1]>frame['sup6'].iloc[-h1] and framew['Close'].iloc[-h1]>framew['sup'].iloc[-h1]):
                ...
                if option2 == 'pullback':  
                   ...
                   and (frame['Dec_EMA50'].iloc[-h1]=='Buy' or frame['Close'].iloc[-h1]>frame['sup6'].iloc[-h1] or framew['Close'].iloc[-h1]>framew['sup'].iloc[-h1]):
