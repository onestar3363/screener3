    ...
    try:
        ...
        #and frame['RISK'].iloc[-1]<=riskvalue:
            ...
            #or framew['Close'].iloc[-1]>framew['sup2'].iloc[-1] or framew['Close'].iloc[-1]>framew['sup4'].iloc[-1])):
                ...
                if option2 == 'breakout':
                   if (frame['EMA20_cross'].iloc[-h1]=='Buy' or frame['EMA50_cross'].iloc[-h1]=='Buy')\
                ...
                if option2 == 'pullback':  
                   if (frame['Decision2 Super'].iloc[-h1]=='Buy2' or frame['Decision Super2'].iloc[-h1]=='Buy2' or frame['Decision Super3'].iloc[-h1]=='Buy2'\
                   or frame['EMA20_cross'].iloc[-h1]=='Buy2' or frame['EMA50_cross'].iloc[-h1]=='Buy2' or frame['EMA200_cross'].iloc[-h1]=='Buy2')\
                   and (frame['Close'].iloc[-h1]>frame['sup4'].iloc[-h1] or frame['Close'].iloc[-h1]>frame['sup6'].iloc[-h1] or frame['Dec_EMA50'].iloc[-1]=='Buy'):
                ...
                if option2 == 'week': 
                   ...
                   #         sira +=1
                   #         expander('cosku')                          
            if option1 == 'Sell' and (framew['Close'].iloc[-1]<framew['sup4'].iloc[-1] or framew['Close'].iloc[-1]<framew['sup6'].iloc[-1])\
